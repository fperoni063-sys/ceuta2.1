-- ==========================================
-- FIX: Corregir mensajes engañosos en email de confirmación
-- Migración: 2026-01-05
-- Cambio: "Cupo Reservado" → "Tu cupo te espera"
-- ==========================================

UPDATE email_templates 
SET 
    asunto = '¡Estás a un paso de {{curso_nombre}}!',
